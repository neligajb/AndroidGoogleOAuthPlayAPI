                    ...
                    mAuthState.performActionWithFreshTokens(mAuthorizationService, new AuthState.AuthStateAction() {
                        ...
                        public void execute(@Nullable String accessToken, @Nullable String idToken, @Nullable AuthorizationException e) {
                            if (e == null) {
                                ...
                                reqUrl = reqUrl.newBuilder().addQueryParameter("maxResults", "3").build();
                                    ...
                                    public void onResponse(Call call, Response response) throws IOException {
                                        ...
                                        try {
                                            ...
                                            final SimpleAdapter postAdapter = new SimpleAdapter(
                                                    ViewPostsActivity.this,
                                                    posts,
                                                    R.layout.google_plus_post_item,
                                                    new String[]{"published", "title"},
                                                    new int[]{R.id.google_plus_item_date, R.id.google_plus_item_text});
